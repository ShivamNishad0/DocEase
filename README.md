...
## for the netlify deploy website

https://doceasee.netlify.app/

## For the backend to work with the frontend, you need to make some changes in the backend code.
https://docease-cdd2.onrender.com
